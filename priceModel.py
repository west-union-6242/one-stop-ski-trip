...
class priceModel:
    ...
    def __init__(self, path, r = 404):
        ...
        #transform title, roomtype and rating
...
print(pm.predict(np.array(["Park City, Utah, United States",40.6843,-111.55089,"Three-Story Ski-In/Ski-Out Townhouse w/ Free WiFi, Shared Pool, Hot Tub, Tennis",8,"Entire townhouse",4.5,"https://www.airbnb.com/rooms/49708135"])))
